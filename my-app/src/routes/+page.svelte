...
<div class="min-h-screen">
	<div class="mx-auto w-full max-w-sm flex-col items-start pt-36">
		<div class="flex flex-col items-start text-center lg:text-left">
			<h1 class="mb-6 text-5xl font-bold">Signup</h1>
			<div class="mb-6">Start your fitness journey today</div>
		</div>
